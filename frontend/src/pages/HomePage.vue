...
import { mdiChevronDown, mdiArrowUp } from '@mdi/js'
...
// Landing components
import CryptoStatistic from '@/components/landing/CryptoStatistic.vue'
import BuyTradeImage from '@/components/landing/BuyTradeImage.vue'
import Exchange from '@/components/landing/Exchange.vue'
import PartnerImage from '@/components/landing/PartnerImage.vue'
import TradingToolImage from '@/components/landing/TradingToolImage.vue'
import ListItem from '@/components/landing/ListItem.vue'
import Step from '@/components/landing/Step.vue'

// Images
import heroImage from '@/assets/img/hero-image.webp'
import nefaCcImage from '@/assets/img/nefa-cc.webp'
import industrySecurityImage from '@/assets/img/industry-leading-security.webp'
...
import arrowImage from '@/assets/img/getting-started/arrow.png'
  ...
  <div class="w-full">
    ...
    <section id="hero" class="w-full pb-24">
      <BaseSection>
        <div class="col-span-12 lg:col-span-6 mt-12 xl:mt-10 space-y-4 sm:space-y-6 px-6 text-center sm:text-left">
          <span data-aos="fade-right" class="text-base text-gradient font-semibold uppercase">Sign Up Today</span>
          <h1
            data-aos="fade-right"
            data-aos-delay="150"
        ...
        <div data-aos="fade-up" class="hidden sm:block col-span-12 lg:col-span-6">
          <div class="w-full">
            <img :src="heroImage" class="-mt-4" alt="" />
          </div>
        </div>
    ...
    >
      <div class="w-full flex flex-col lg:flex-row items-center justify-center">
        <CryptoStatistic data-aos="fade-up" title="🔥 Trending" :datasets="trendings" class="xl:border-r border-gray-200 lg:px-8" />
        <CryptoStatistic data-aos="fade-up" data-aos-delay="150" title="🚀 Top Gainers" :datasets="topGainers" class="xl:border-r border-gray-200 lg:px-8" />
        <CryptoStatistic data-aos="fade-up" data-aos-delay="300" title="💎 Recently Added" :datasets="recents" class="lg:px-8" />
      </div>
    </section>
    ...
    <section class="bg-partner relative max-w-full sm:mx-6 my-24 shadow sm:rounded-2xl overflow-hidden">
      <div class="w-full px-6 sm:px-0 py-16 flex flex-col items-center justify-center space-y-4 text-center">
        ...
        <p data-aos="flip-down" data-aos-delay="150" class="paragraph">We're partners with countless major organisations around the globe</p>
        <div data-aos="fade-up" data-aos-delay="250" class="flex flex-wrap items-center justify-center">
          <PartnerImage v-for="img in ['clever.png', 'diamon-cutts.png', 'swiss-finance.png', 'gambio.png']" :key="img" :img="img" />
        </div>
      </div>
    </section>
    ...
    <section class="w-full my-36">
      <BaseSection>
        <div data-aos="fade-right" class="col-span-12 lg:col-span-7">
          <div class="w-full">
            <img :src="nefaCcImage" class="w-[95%]" alt="" />
          </div>
        </div>
        <div data-aos="fade-left" class="col-span-12 lg:col-span-5 space-y-6 px-4 sm:px-6 mt-20">
    ...
    <section class="bg-trading-tools relative max-w-full sm:mx-4 my-20 py-16 shadow rounded-2xl overflow-hidden">
      <div class="relative max-w-screen-xl px-4 sm:px-2 mx-auto grid grid-cols-12 gap-x-6">
        ...
        <TradingToolImage data-aos="fade-left" class="hidden sm:block" />
      </div>
    </section>
    ...
    <section class="w-full my-24">
      <div class="relative max-w-screen-xl px-8 mx-auto grid grid-cols-12 gap-x-6">
        <div data-aos="fade-right" class="col-span-12 lg:col-span-6">
          <div class="w-full">
            <img :src="industrySecurityImage" class="w-full" alt="" />
          </div>
        </div>
    ...
    <section class="bg-trading-tools relative max-w-full sm:mx-4 xl:mx-10 my-24 shadow sm:rounded-2xl overflow-hidden">
      <div class="w-full py-16 flex flex-col items-center">
        ...
        >
          <Step v-for="step in steps" :key="step.title" :step="step" />
          <img :src="arrowImage" class="hidden lg:inline-block absolute top-32 left-64 xl:left-[22rem] w-24 xl:w-[9.5rem]" alt="" />
          <img :src="arrowImage" class="hidden lg:inline-block absolute top-32 right-64 xl:right-[22rem] w-24 xl:w-[9.5rem]" alt="" />
        </div>
      </div>
    </section>
    ...
    <section class="w-full my-24">
      <BaseSection>
        <div data-aos="fade-right" class="col-span-12 lg:col-span-6">
          <div class="w-full">
            <img :src="faqImage" class="w-full" alt="" />
          </div>
        </div>
